...
<div class="content-wrapper"><!-- AdminLTE pattern -->
  ...
  <section class="content">
    <div class="container">
      ...
      <!-- Formularios lado a lado (responsive y colapsables) -->
...
document.addEventListener('DOMContentLoaded', function() {
  // =======================================
  // Toggle Flechas Dinámicas
  // =======================================
  const toggleCollapse = (collapseId, iconId) => {
  ...
  toggleCollapse('collapseActualizar', 'iconActualizar');
  toggleCollapse('collapseConsultar', 'iconConsultar');
});
</script>
@endsection
